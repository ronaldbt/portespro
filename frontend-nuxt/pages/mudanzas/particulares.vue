    ...
    <main class="flex-grow">
        ...
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tighter">
              {{ $t('pages.mudanzasParticulares.services.title') }}
            </h2>
            <p class="text-lg text-slate-500 max-w-2xl mx-auto font-medium">
              {{ $t('pages.mudanzasParticulares.services.subtitle') }}
            </p>
          </div>
      ...
      <section class="py-24 bg-slate-50">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tighter">
              {{ $t('pages.mudanzasParticulares.benefits.title') }}
            </h2>
            <p class="text-lg text-slate-500 max-w-2xl mx-auto font-medium">
              {{ $t('pages.mudanzasParticulares.benefits.subtitle') }}
            </p>
          </div>
      ...
      <section class="py-24 bg-white">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tighter">
              {{ $t('pages.mudanzasParticulares.process.title') }}
            </h2>
            <p class="text-lg text-slate-500 max-w-2xl mx-auto font-medium">
              {{ $t('pages.mudanzasParticulares.process.subtitle') }}
            </p>
          </div>
        ...
        <div class="container mx-auto px-4 relative z-10">
          <div class="max-w-4xl mx-auto text-center">
            <h2 class="text-4xl md:text-6xl font-black mb-8 tracking-tighter">
              {{ $t('pages.mudanzasParticulares.cta.title') }}
            </h2>
            <p class="text-xl text-slate-300 mb-12 font-medium">
              {{ $t('pages.mudanzasParticulares.cta.subtitle') }}
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                {{ $t('pages.mudanzasParticulares.cta.button1') }}
              </button>
              <button
                @click="scrollToCalc"
              ...
              >
                {{ $t('pages.mudanzasParticulares.cta.button2') }}
              </button>
            </div>
          </div>
        </div>
      ...
      <section class="py-24 bg-white">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tighter">
              {{ $t('pages.mudanzasParticulares.faqs.title') }}
            </h2>
            <p class="text-lg text-slate-500 max-w-2xl mx-auto font-medium">
              {{ $t('pages.mudanzasParticulares.faqs.subtitle') }}
            </p>
          </div>
...
const services = computed(() => [
  {
    icon: IconHome,
    title: t('pages.mudanzasParticulares.services.service1.title'),
    desc: t('pages.mudanzasParticulares.services.service1.description')
  },
  {
    icon: IconPackage,
    title: t('pages.mudanzasParticulares.services.service2.title'),
    desc: t('pages.mudanzasParticulares.services.service2.description')
  },
  {
    icon: IconShield,
    title: t('pages.mudanzasParticulares.services.service3.title'),
    desc: t('pages.mudanzasParticulares.services.service3.description')
  }
])
...
const benefits = computed(() => [
  {
    icon: '💰',
    title: t('pages.mudanzasParticulares.benefits.benefit1.title'),
    desc: t('pages.mudanzasParticulares.benefits.benefit1.description')
  },
  {
    icon: '⚡',
    title: t('pages.mudanzasParticulares.benefits.benefit2.title'),
    desc: t('pages.mudanzasParticulares.benefits.benefit2.description')
  },
  {
    icon: '🛡️',
    title: t('pages.mudanzasParticulares.benefits.benefit3.title'),
    desc: t('pages.mudanzasParticulares.benefits.benefit3.description')
  },
  {
    icon: '📦',
    title: t('pages.mudanzasParticulares.benefits.benefit4.title'),
    desc: t('pages.mudanzasParticulares.benefits.benefit4.description')
  }
])

const processSteps = computed(() => [
  {
    title: t('pages.mudanzasParticulares.process.step1.title'),
    description: t('pages.mudanzasParticulares.process.step1.description')
  },
  {
    title: t('pages.mudanzasParticulares.process.step2.title'),
    description: t('pages.mudanzasParticulares.process.step2.description')
  },
  {
    title: t('pages.mudanzasParticulares.process.step3.title'),
    description: t('pages.mudanzasParticulares.process.step3.description')
  },
  {
    title: t('pages.mudanzasParticulares.process.step4.title'),
    description: t('pages.mudanzasParticulares.process.step4.description')
  }
])
...
const currentUrl = computed(() => `${siteUrl}/mudanzas/particulares`)
const defaultImage = `${siteUrl}/og-image.jpg`

useHead(computed(() => ({
  title: t('pages.mudanzasParticulares.seo.title'),
  meta: [
    { name: 'description', content: t('pages.mudanzasParticulares.seo.description') },
    { name: 'keywords', content: t('pages.mudanzasParticulares.seo.keywords') },
    { property: 'og:type', content: 'website' },
    { property: 'og:url', content: currentUrl.value },
    { property: 'og:title', content: t('pages.mudanzasParticulares.seo.ogTitle') },
    { property: 'og:description', content: t('pages.mudanzasParticulares.seo.ogDescription') },
    { property: 'og:image', content: defaultImage },
    { property: 'og:site_name', content: 'PortesPro' },
    { property: 'og:locale', content: 'es_ES' },
    { name: 'twitter:card', content: 'summary_large_image' },
    { name: 'twitter:url', content: currentUrl.value },
    { name: 'twitter:title', content: t('pages.mudanzasParticulares.seo.twitterTitle') },
    { name: 'twitter:description', content: t('pages.mudanzasParticulares.seo.twitterDescription') },
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        '@type': 'Service',
        serviceType: t('pages.mudanzasParticulares.seo.schemaServiceType'),
        provider: {
          '@type': 'LocalBusiness',
          name: 'PortesPro',
          url: siteUrl
        ...
        description: t('pages.mudanzasParticulares.seo.schemaDescription')
      })
    },
    {
      type: 'application/ld+json',
      children: JSON.stringify({
        ...
        itemListElement: [
          ...
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: t('nav.mudanzasParticulares'),
