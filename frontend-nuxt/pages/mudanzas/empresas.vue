    ...
    <main class="flex-grow">
        ...
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tighter">
              {{ $t('pages.mudanzasEmpresas.services.title') }}
            </h2>
            <p class="text-lg text-slate-500 max-w-2xl mx-auto font-medium">
              {{ $t('pages.mudanzasEmpresas.services.subtitle') }}
            </p>
          </div>
      ...
      <section class="py-24 bg-slate-50">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tighter">
              {{ $t('pages.mudanzasEmpresas.benefits.title') }}
            </h2>
            <p class="text-lg text-slate-500 max-w-2xl mx-auto font-medium">
              {{ $t('pages.mudanzasEmpresas.benefits.subtitle') }}
            </p>
          </div>
      ...
      <section class="py-24 bg-white">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tighter">
              {{ $t('pages.mudanzasEmpresas.process.title') }}
            </h2>
            <p class="text-lg text-slate-500 max-w-2xl mx-auto font-medium">
              {{ $t('pages.mudanzasEmpresas.process.subtitle') }}
            </p>
          </div>
        ...
        <div class="container mx-auto px-4 relative z-10">
          <div class="max-w-4xl mx-auto text-center">
            <h2 class="text-4xl md:text-6xl font-black mb-8 tracking-tighter">
              {{ $t('pages.mudanzasEmpresas.cta.title') }}
            </h2>
            <p class="text-xl text-slate-300 mb-12 font-medium">
              {{ $t('pages.mudanzasEmpresas.cta.subtitle') }}
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                {{ $t('pages.mudanzasEmpresas.cta.button1') }}
              </button>
              <button
                @click="scrollToCalc"
              ...
              >
                {{ $t('pages.mudanzasEmpresas.cta.button2') }}
              </button>
            </div>
          </div>
        </div>
      ...
      <section class="py-24 bg-white">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tighter">
              {{ $t('pages.mudanzasEmpresas.faqs.title') }}
            </h2>
            <p class="text-lg text-slate-500 max-w-2xl mx-auto font-medium">
              {{ $t('pages.mudanzasEmpresas.faqs.subtitle') }}
            </p>
          </div>
...
const services = computed(() => [
  {
    icon: IconHome,
    title: t('pages.mudanzasEmpresas.services.service1.title'),
    desc: t('pages.mudanzasEmpresas.services.service1.description')
  },
  {
    icon: IconPackage,
    title: t('pages.mudanzasEmpresas.services.service2.title'),
    desc: t('pages.mudanzasEmpresas.services.service2.description')
  },
  {
    icon: IconShield,
    title: t('pages.mudanzasEmpresas.services.service3.title'),
    desc: t('pages.mudanzasEmpresas.services.service3.description')
  }
])
...
const benefits = computed(() => [
  {
    icon: '💰',
    title: t('pages.mudanzasEmpresas.benefits.benefit1.title'),
    desc: t('pages.mudanzasEmpresas.benefits.benefit1.description')
  },
  {
    icon: '⚡',
    title: t('pages.mudanzasEmpresas.benefits.benefit2.title'),
    desc: t('pages.mudanzasEmpresas.benefits.benefit2.description')
  },
  {
    icon: '🛡️',
    title: t('pages.mudanzasEmpresas.benefits.benefit3.title'),
    desc: t('pages.mudanzasEmpresas.benefits.benefit3.description')
  },
  {
    icon: '📦',
    title: t('pages.mudanzasEmpresas.benefits.benefit4.title'),
    desc: t('pages.mudanzasEmpresas.benefits.benefit4.description')
  }
])

const processSteps = computed(() => [
  {
    title: t('pages.mudanzasEmpresas.process.step1.title'),
    description: t('pages.mudanzasEmpresas.process.step1.description')
  },
  {
    title: t('pages.mudanzasEmpresas.process.step2.title'),
    description: t('pages.mudanzasEmpresas.process.step2.description')
  },
  {
    title: t('pages.mudanzasEmpresas.process.step3.title'),
    description: t('pages.mudanzasEmpresas.process.step3.description')
  },
  {
    title: t('pages.mudanzasEmpresas.process.step4.title'),
    description: t('pages.mudanzasEmpresas.process.step4.description')
  }
])

const faqs = computed(() => [
  {
    question: t('pages.mudanzasEmpresas.faqs.faq1.question'),
    answer: t('pages.mudanzasEmpresas.faqs.faq1.answer'),
    open: false
  },
  {
    question: t('pages.mudanzasEmpresas.faqs.faq2.question'),
    answer: t('pages.mudanzasEmpresas.faqs.faq2.answer'),
    open: false
  },
  {
    question: t('pages.mudanzasEmpresas.faqs.faq3.question'),
    answer: t('pages.mudanzasEmpresas.faqs.faq3.answer'),
    open: false
  },
  {
    question: t('pages.mudanzasEmpresas.faqs.faq4.question'),
    answer: t('pages.mudanzasEmpresas.faqs.faq4.answer'),
    open: false
  },
  {
    question: t('pages.mudanzasEmpresas.faqs.faq5.question'),
    answer: t('pages.mudanzasEmpresas.faqs.faq5.answer'),
    open: false
  },
  {
    question: t('pages.mudanzasEmpresas.faqs.faq6.question'),
    answer: t('pages.mudanzasEmpresas.faqs.faq6.answer'),
    open: false
  }
])
...
useHead(computed(() => ({
  ...
  meta: [
    ...
    { property: 'og:description', content: t('pages.mudanzasEmpresas.seo.ogDescription') },
    { property: 'og:image', content: defaultImage },
    { property: 'og:site_name', content: 'PortesPro' },
    { property: 'og:locale', content: 'es_ES' },
    { name: 'twitter:card', content: 'summary_large_image' },
    { name: 'twitter:url', content: currentUrl.value },
    { name: 'twitter:title', content: t('pages.mudanzasEmpresas.seo.twitterTitle') },
    { name: 'twitter:description', content: t('pages.mudanzasEmpresas.seo.twitterDescription') },
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        '@type': 'Service',
        serviceType: t('pages.mudanzasEmpresas.seo.schemaServiceType'),
        provider: {
          '@type': 'LocalBusiness',
          name: 'PortesPro',
          url: siteUrl
        ...
        description: t('pages.mudanzasEmpresas.seo.schemaDescription')
      })
    },
    {
      type: 'application/ld+json',
